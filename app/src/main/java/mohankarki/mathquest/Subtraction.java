...
public class Subtraction extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        full = 90000; //total time for the quiz
        half = 15000; //time for each question.
        playAgain();
    }
    ...
    public void generateQuestion(){
        ...
        int add_answer = calculation.subtraction_result(a,b);
        ...
        for(int i = 0; i<4; i++){
            if(i == locationOFCorrect){
                ...
                incorrectAnswer = calculation.get_random_number1(41,21);
    ...
    public void medium_Question(){
        ...
        for(int i = 0; i<4; i++){
            if(i == locationOFCorrect){
                ...
                incorrectAnswer = calculation.get_random_number1(32, -31);
                while(incorrectAnswer == add_answer){
                    incorrectAnswer = calculation.get_random_number1(32, -31);
                }
                answers.add(incorrectAnswer);
    ...
    public void hard_Question(){
        ...
        int add_answer = calculation.subtraction_result_three(a,b,c);
        ...
        for(int i = 0; i<4; i++){
            if(i == locationOFCorrect){
                ...
                incorrectAnswer = calculation.get_random_number1(22, -32);
                while(incorrectAnswer == add_answer){
                    incorrectAnswer = calculation.get_random_number1(22, -32);
                }
                answers.add(incorrectAnswer);
    ...
    public void save_data_to_sharedPreferences(){
        ...
        sharedPreferencesinAddition = getSharedPreferences("Sub", Context.MODE_PRIVATE);
